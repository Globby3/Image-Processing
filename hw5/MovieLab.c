...
int main(int argc, char *argv[])
{
        ...
        while (x < argc) {
                ...
                /* determine how many frames are read from the input stream */
                ...
                /* activate the black and white filter */
                ...
                /*  crop the movie frames from <start> to <end> */
                if (strcmp(argv[x], "-crop") == 0) {
                        if (x < argc - 1) {
                                char *start = argv[x + 1];
                                char *end = argv[x + 2];
                                CropImageList(image, start, end);
                        } 
                        else {
                                printf("Missing argument for the crop!\n");
                                return 5;
                        } 
                        x += 2;
                        continue;
                ...
                /* fast forward the movie by <factor> (>= 1) */
                if (strcmp(argv[x], "-fast") == 0) {
                        if (x < argc - 1) {
                                char *factor = argv[x + 1];
                                FastImageList(image, factor);
                        } 
                        else {
                ...
                /*  reverse the frame order of the input movie */
                if (strcmp(argv[x], "-reverse") == 0) {
                        ReverseImageList(image);
                        continue;
                } 

                /* add a watermark from <file> to every movie frame */
                ...
                /*  fade in and fade out the copies of the first and last frames of the movie */
                if (strcmp(argv[x], "-spotlight") == 0) {
                        Spotlight(image, width/2, height/2, );
                        continue;
                } 
